...
| GitHub repository | Local Git repository initialised in the project folder with `.gitignore` and commits (not pushed — publishing requires explicit approval); the report carries the repository URL https://github.com/athisayaprema2007-hue/CSA0312-Intelligent-Evacuation-Routing-System |
